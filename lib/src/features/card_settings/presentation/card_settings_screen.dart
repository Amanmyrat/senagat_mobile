                                ...
                                children: [
                                  Row(
                                    children: [
                                      ...
                                      SizedBox(width: 10.w,),
                                      Text(r'Реквизиты карты'.tr, style: TextStyle(color: AppColors.black, fontSize: 14.sp, fontFamily: AppFonts.secondaryFont),),
                                    ],
                                  ),
                                            ...
                                            child: SizedBox(
                                              ...
                                              child: Padding(
                                                ...
                                                child: Column(
                                                  ...
                                                  children: [
                                                    Text(r'Название карты'.tr, style: TextStyle(color: AppColors.black, fontSize: 24.sp),),
                                ...
                                children: [
                                  Row(
                                    children: [
                                      ...
                                      SizedBox(width: 10.w,),
                                      Text(r'Название карты'.tr, style: TextStyle(color: AppColors.black, fontSize: 14.sp,fontFamily: AppFonts.secondaryFont),),
                                    ],
                                  ),
                                  SvgPicture.asset(AppAssets.arrowRightIcon, width: 16.w,)
                                ],
                            ...
                            children: [
                              Row(
                                children: [
                                  ...
                                  SizedBox(width: 10.w,),
                                  Text(r'Удалить карту'.tr, style: TextStyle(color: AppColors.black, fontSize: 14.sp,fontFamily: AppFonts.secondaryFont),),
                                ],
                              ),
                              SvgPicture.asset(AppAssets.arrowRightIcon, width: 16.w,)
                            ],

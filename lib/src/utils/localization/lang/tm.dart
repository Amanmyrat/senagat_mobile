const Map<String, String> tmTm = {
  ...
  r'check_bank': r'Bank tarapyndan barlag',
  ...
  r'remove_card': r'Kartany pozmak',
  ...
  r'credits': r'Karzlar',
  r'select_the_type_of_certificate': r'Sprawkanyň görnüşini saýlaň',
  r'type_of_certificate': r'Sprawkanyň görnüşi',
  ...
  r'get_a_card_in_just_a_few_seconds': r'Kartyny diňe birnäçe sekuntda alyň',
  r'get_a_credit_in_just_a_few_seconds': r'Kredit üçin diňe birnäçe sekuntda ýüz tutuň',
  r'most_functions': r'Profilinizi dolduranyňyzdan soň funksiýalaryň köpüsi işlär',

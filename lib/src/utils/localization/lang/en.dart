const Map<String, String> enUs = {
  ...
  r'pay_everything': r'Your future is with us',
  ...
  r'find_an_branch': r'Find an branch',
  r'atm': r'ATMs',
  r'branch': r'Branchs',
  ...
  r'gas': r'Gas',
  r'water': r'Water',
  r'state_traffic_safety_inspectorate': r'Traffic Police Service',
  r'light': r'Light',
  ...
  r'entrepreneur': r'Are you an entrepreneur',
  r'manager': r'Manager',
  ...
  r'about_Us_v1.0': r'About Us v@version',
  ...
  r'version_1.0': r'Version @version',
  r'application_update_v1.0': r'Application update v@version',
  ...
  r'profile': r'Profile',
  r'get_a_card': r'Get a card',
  r'get_a_credit': r'Get a credit',
  ...
  r'account_not_found': r'Account not found',
  r'asgabat_number_or_region':'12+ Ashgabat number or region code + number',
